...
if __name__ == '__main__':
    coverSheetsPath = 'C:\\Users\\cmolina\\Downloads\\submittal\\CoverSheet'
    ...
    sortedFiles = sortFileNames(fileNames=getLocalFileNames(submittalPath),
                                by=getNumberHead)
    merge_pdfs(srcFileNames=sortedFiles,
               dstFileName=f'{submittalPath}\\submittal binder.pdf')
